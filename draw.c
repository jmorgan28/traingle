...
void add_sphere( struct matrix * edges, 
  ...
  /*longStart = 0;
  for ( longt = longStart; longt <= longStop; longt++ ) {
    int indexi = latStart * (num_steps) + longt;
    int indexii = (latStop - 1) * (num_steps) + longt;
    add_polygon( edges,
		 points->m[0][indexii],
		 points->m[1][indexii],
		 points->m[2][indexii],
		 ...
		 points->m[1][indexi] ,
		 points->m[2][indexi]  ,
		 points->m[0][indexi + num_steps]  ,
		 points->m[1][indexi + num_steps] ,
		 points->m[2][indexi + num_steps] );
    add_polygon( edges,
		 points->m[0][indexii],
		 points->m[1][indexii],
		 points->m[2][indexii],
		 ...
		 points->m[1][indexi + num_steps] ,
		 points->m[2][indexi + num_steps],
		 points->m[0][indexii + num_steps] ,
		 points->m[1][indexii + num_steps] ,
		 points->m[2][indexii + num_steps]);
    //printf("%d \n",lat);
    //printf("%d \n",num_steps);
    }*/
